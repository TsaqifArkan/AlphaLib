        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <option value="" disabled <?=!isset($idkls) ? "selected" : ''; ?>>--Pilih Klasifikasi--</option>
                        <?php foreach ($klas as $k): ?>
                            <option value="<?= esc($k['idklasifikasi']); ?>"
                            <?= (esc($k['idklasifikasi']) == $idkls) ? "selected" : '';?>
                            >(<?= esc($k['noklas']); ?>) - <?= esc($k['nama']); ?></option>
                        <?php endforeach; ?>
                    </select>
